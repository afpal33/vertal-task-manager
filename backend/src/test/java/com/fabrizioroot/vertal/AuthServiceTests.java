...
class AuthServiceTests {
    @Test void linkingRequestIsPending() {
        ...
        AuthService service = new AuthService(organizations, requests, mock(UsuarioRepository.class), mock(DispositivoRepository.class), mock(VinculacionDispositivoRepository.class), mock(JwtService.class), "server-key");
    ...
    @Test void challengeLoginUsesPublicKeyAndConsumesChallenge() throws Exception {
        ...
        AuthService service=new AuthService(mock(OrganizacionRepository.class),mock(SolicitudVinculacionRepository.class),mock(UsuarioRepository.class),devices,mock(VinculacionDispositivoRepository.class),jwt,"server-key");
    ...
    @Test void approvalCreatesActiveUserAndDeviceLink() {
        ...
        AuthService service = new AuthService(mock(OrganizacionRepository.class), requests, users, devices, links, mock(JwtService.class), "server-key");
    ...
    @Test void rejectionDoesNotActivateAnything() {
        ...
        AuthService service = new AuthService(mock(OrganizacionRepository.class), requests, mock(UsuarioRepository.class), mock(DispositivoRepository.class), mock(VinculacionDispositivoRepository.class), mock(JwtService.class), "server-key");
